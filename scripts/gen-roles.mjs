// 生成 agent-teams-pixel 的角色目录 JSON（冻结数据，随插件包分发，不依赖运行时文件系统）。
// 用法：node plugins/agent-teams-pixel/scripts/gen-roles.mjs
...
// 输出：plugins/agent-teams-pixel/lib/roles.json + roles-full.json
